...
public class AdminController {
	 ...
	 * @Throws
	 */
	@RequestMapping(value = "/addGrades", method = RequestMethod.POST, produces= MediaType.APPLICATION_JSON)
	@ResponseBody
	 ...
	 * @Throws
	 */
	@RequestMapping(value = "/approveStudents/{id}", method = RequestMethod.PUT, produces= MediaType.APPLICATION_JSON)
	@ResponseBody
